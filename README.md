...
This repository contains an implementation of an Outlook Universal MCP (Model Context Protocol) server. It provides a standardized interface for interacting with Outlook's SEO and backlink analysis tools through a unified API.
